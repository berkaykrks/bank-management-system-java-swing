...
public class kullaniciVerileri {
	   ...
	   private double kartBorc;
	    ...
	    public kullaniciVerileri(String firstName, String lastName, String telefonNumarasi, String adres,String dogumTarih,
	    		String sifre, String hesapNumarasi, String tcKimlik, Double bakiye, Double kartEkstre, Double kartBorc) {
